  ...
  if (estado.equals( "juego" )) {
    ...
    /* FBody ball = null;
      if (uno == bolsa && nombreDos != "movible") {
        ...
        ball = uno;
      }else if (uno==bolsa && nombreDos!="puntero"){
        ball =uno;
      }else if(dos==bolsa && nombreUno!="puntero"){
        ball=dos;
      }
      if (ball == null) {
        return;
      ...
      mundo.remove(ball);*/
FBody ball = null;
      if ( (uno == bolsa && nombreDos == "caramelo_rosa")
        || (uno == bolsa && nombreDos == "caramelo_amarillo")
        || (uno == bolsa && nombreDos == "caramelo_violeta")
        || (uno == bolsa && nombreDos == "caramelo_celeste")
        ) {
        ball = dos;
      } else if ( (dos == bolsa && nombreUno == "caramelo_rosa")
        || (dos == bolsa && nombreUno == "caramelo_amarillo")
        || (dos == bolsa && nombreUno == "caramelo_violeta")
        || (dos == bolsa && nombreUno == "caramelo_celeste")
        ) {
        ball = uno;
      }
      //if (uno == bolsa && nombreDos != "movible") {
